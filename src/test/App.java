...
public class App {
    public static void main(String[] args) {
        ...
        FCarSystem system = Data.getInstance().getSystem();
        ...
        rental.setCustomer(system.findCustomer(Data.getInstance().getSystem().getCustomers().get(0).getCustomerId()));
        System.out.println(system.bookCarRental(rental));

        System.out.println("start");
        Rental rental1 = new Rental();
        rental1.setCustomer(system.findCustomer(Data.getInstance().getSystem().getCustomers().get(1).getCustomerId()));
        ...
        for (Rental rental2 : system.findCarRentalByCustomerId(Data.getInstance().getSystem().getCustomers().get(0).getCustomerId())) {
